/**
 * Personnalized by dlouvard on 26/12/2015. To abord function
 */
function bigUpload () {
    ...
    this.abortFileUpload = function() {
        ...
        xhr.send(data);
        parent.resetKey();
        this.$(this.settings.submitButton).value = 'Start Upload';
        this.$(this.settings.inputField).value = '';
        this.$(this.settings.progressBarField).style.width =  '0px';
